...
<div class="p-6 bg-white rounded-lg shadow-lg dark:bg-gray-800 max-w-md w-full md:w-[450px] h-auto max-h-auto mx-auto flex flex-col print-container">
    ...
    <div id="print-area" class="flex-1 w-auto p-4">
        ...
        <div class="grid grid-cols-4 gap-1 text-base font-bold">
            ...
            <div class="col-span-1">Tanggal</div><div class="col-span-1 text-center">:</div><div class="col-span-2 text-end">{{ now()->setTimezone('Asia/Makassar')->format('d/m/Y H:i') }} WITA</div>
        ...
        <div class="grid grid-cols-5 gap-1 pt-3 text-lg font-bold">
            <div class="col-span-2">Subtotal</div><div class="col-span-1">:</div><div class="col-span-2 text-end">Rp. {{ number_format($total_harga, 0, ',', '.') }}</div>
            <div class="col-span-2">Total</div><div class="col-span-1">:</div><div class="col-span-2 text-end">Rp. {{ number_format($total_harga, 0, ',', '.') }}</div>
            <div class="col-span-2">Tunai</div><div class="col-span-1">:</div><div class="col-span-2 text-end">Rp. {{ number_format($tunai_amount, 0, ',', '.') }}</div>
            <div class="col-span-2">Kembalian</div><div class="col-span-1">:</div><div class="col-span-2 text-end">Rp. {{ number_format($kembalian, 0, ',', '.') }}</div>
        </div>
